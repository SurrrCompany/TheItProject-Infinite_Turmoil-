...
if (no=6) {
    if (no1=1) {obj_player1.hp+=20 global.inv_item[global.inv_select,0]=0 global.inv_item[global.inv_select,1]=0} //add hp and remove item
    if (no1=2) {drop_item(global.inv_select)}   //Drop
}
if (no=7) {
    if (no1=1) {show_message("Wear!!")}         //Simple message
...
if (no=8) {
    if (no1=1) {obj_player1.hp+=10 global.inv_item[global.inv_select,0]=0 global.inv_item[global.inv_select,1]=0} //add hp and remove item
...
if (no=9) {
    ...
    if (no1=8) {obj_player1.hp+=1 global.inv_item[global.inv_select,0]=0 global.inv_item[global.inv_select,1]=0}
